...
curl -O https://raw.githubusercontent.com/honeydmt/Script/main/drivers/PHDGD_Skylake_2.9.7z
curl -O https://raw.githubusercontent.com/honeydmt/Script/main/drivers/7347_Chipset_Driver_WFF6P_WN_9.4.0.1027_A00.EXE
curl -O https://raw.githubusercontent.com/honeydmt/Script/main/drivers/Chipset_Driver_8HX85_WN32_8.1.10605.221_A01.EXE
...
curl -O https://raw.githubusercontent.com/honeydmt/Script/main/progams/VisualCppRedist_AIO_x86_x64.exe

echo Using KMS VL ALL AIO to activate windows
echo .

:: Open KMS VL ALL AIO
"C:\Users\Daniel Honey\Downloads\scripts\post-install\KMS_VL_ALL_AIO.cmd"

echo Install DirectX
echo .

:: Open dxwebsetup
"C:\Users\Daniel Honey\Downloads\scripts\post-install\dxwebsetup.exe"

echo Run VisualCppRuntime
echo .
